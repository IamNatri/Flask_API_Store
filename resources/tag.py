...
class TagsInStore(MethodView):
    ...
    def post(self, tag_data, store_id):
        # this part is now handle by the tag model
...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        if item.store.id != tag.store_id:
            abort(400, message="No tag available to that store item.")
        ...
        try:
            ...
            abort(500, message="An error occurred inserting tag")
